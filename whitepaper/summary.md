...
2. 以獎勵為驅動力\
   道易程對每筆代幣交易抽取2%的手續費，並獎勵給對應的DAO的開發者。這種獎勵機制可以驅動所有的dApp成為智能公物（Smart Commons）。
3. 驅動所有的dApp成為智能公物/公共品（Smart Commons）\
   Mint DAO意味着開發者自願將其開發的dApp轉為智能公物（Smart Commons，即Public Goods的一種）。這一協定（特別是其子協議SC0）符合 DAism 對培育公共公共資源/公共品和開放協作生態系統的承諾。
