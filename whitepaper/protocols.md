...
> **SC0 v0.1**
>
> 用一個dApp Mint DAO意味着該dApp接受本協議成為其唯一協議，也接受其所有者和管理者（我們稱之為DAO的成員）全部匿名這一事實。
>
> 1、無著作權\
> 匿名意味着其開發的dApp完全貢獻至公共領域，成為公共資源，除享受價值證明（Proof-of-Work）帶來的獎勵外，放棄所有其它權利，包括所有相關權利和鄰接權利。
>
> 2、無責任\
> 匿名意味着該DAO的成員，不對其dApp及其專屬估值通證提供任何形式的擔保，不承擔任何連帶責任。 當使用或調用本dApp，或投資本DAO專屬估值通證時，任何人不得暗示本DAO或本DAO的任何成員為他或她的行為背書。
